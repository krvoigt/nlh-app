		...
		<table class="values">
			<tr>
				...
				<td class="value">
					...
					<xsl:text> </xsl:text>
					<a class="link" href="http://dfg-viewer.de/v2?set[mets]=http%3A%2F%2Fwww.digizeitschriften.de%2Fmain%2Fdms%2Fmetsresolver%2F%3FPPN%3D{substring(oai:identifier,30)}">DFG-Viewer</a>
					<xsl:text> </xsl:text>
