...
class IpAuthenticationListener
{
    ...
    public function __construct(AuthorizationService $authorizationService, DocumentService $documentService, $registrationLink)
    {
    ...
    public function onKernelController(FilterControllerEvent $event)
    {
        ...
        if (php_sapi_name() !== 'cli') {
            if ($controller[0] instanceof IpAuthenticatedController and $controller[1] === 'detailAction') {
